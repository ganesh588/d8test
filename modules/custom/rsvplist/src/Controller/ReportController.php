...
class ReportController extends ControllerBase {
  /**
   * Gets all the RSVPs for all nodes.
   * 
   * @return array
   */
  ...
  public function report() {
    ...
    $content['message'] = array(
      '#markup' => $this->t('Below is the list of all Event RSVPs including username, email address and the name of the event they wiil be attending'),            
    );
    $headers = array(
      t('Name'),
      t('Event'),
